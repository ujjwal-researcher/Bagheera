    ...
    ClassificationDataset<T1>
{
    ...
    ///
    /// ```rust
    /// use bagheera::classification_old::ClassificationDataset;
    ///
    ...
    > ClassificationJudge<'a, T1, T2, T3>
{
    ...
    ///
    /// ```rust
    /// use bagheera::classification_old;
    ///
    /// let mut cls_db = classification_old::ClassificationDataset::<u8>::new(10u8, false);
